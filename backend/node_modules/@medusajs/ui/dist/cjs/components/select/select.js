...
const Separator = React.forwardRef(({ className, ...props }, ref) => (React.createElement(radix_ui_1.Select.Separator, { ref: ref, className: (0, clx_1.clx)("bg-ui-border-component border-t-ui-border-menu-top border-b-ui-border-menu-bot -mx-1 my-1 h-0.5 border-b border-t", className), ...props })));
