          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-JVV7ZQOA.mjs")
                    },
                    {
                      path: "import",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-HBFJISYZ.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-HBFJISYZ.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-CVYOZK46.mjs")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-IAJODIBN.mjs")
                        },
                        {
                          path: "sales-channels",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-6KJUE6GG.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-PKZJ74EN.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-FA3UAU7A.mjs")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-KHBER6UE.mjs")
                        },
                        {
                          path: "prices",
                        ...
                        },
                        {
                          ...
                          lazy: () => import("./product-create-variant-LMM7MCLY.mjs")
                        },
                        {
                          path: "stock",
                    ...
                    },
                    {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-XJEJW35P.mjs")
                        },
                        {
                          path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./order-detail-ZD3S536D.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-ZO4M5SNQ.mjs")
                    },
                    {
                    ...
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-4T4DXNP7.mjs")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-T2FBEXOQ.mjs")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-AEMOZGTG.mjs")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-EWYEFSHV.mjs")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-I7ZZWLFJ.mjs")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-CNXHL2ZY.mjs")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-ICL7BC2B.mjs")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-7XUKNU22.mjs")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-NPP6ZOAE.mjs")
                    },
                    {
                      path: "metadata/edit",
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-WS74DGAU.mjs")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-HYNZCKXP.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./promotion-detail-ME7L4QFX.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-WWTN2XK2.mjs")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                ...
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component, Breadcrumb, loader } = await import("./campaign-detail-VPVCGALN.mjs");
                    return {
                      Component,
                      loader,
                      handle: {
                  ...
                  children: [
                    ...
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-IEUNRQLL.mjs")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-XIYRCMCL.mjs")
                    }
                  ]
                },
                {
          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-PV3IW352.mjs")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-MMNZ7YFU.mjs")
                    },
                    {
                      path: "countries/add",
            ...
            },
            {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-HY5BXMVX.mjs")
                },
                {
                  path: "currencies",
                          ...
                          children: [
                            ...
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-TEMRUOLU.mjs")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-PV7BGNGF.mjs")
                                    },
                                    {
                                      path: "pricing",
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-27U7XRGU.mjs")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component } = await import("./tax-region-detail-WCYWAVKW.mjs");
                        return {
                          Component
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-TWPGKM4L.mjs")
                        },
                        {
                    ...
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component, Breadcrumb, loader } = await import("./tax-region-province-detail-6X46BRIN.mjs");
                        return {
                          Component,
                          loader,
                          handle: {
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-LHHZBHSH.mjs")
            },
            {
              path: "/invite",
