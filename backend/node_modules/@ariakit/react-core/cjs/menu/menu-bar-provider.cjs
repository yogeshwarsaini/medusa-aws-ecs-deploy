...
var _SMHJOY6Pcjs = require('../__chunks/SMHJOY6P.cjs');
require('../__chunks/HLFPESUH.cjs');
require('../__chunks/UHDKHSPL.cjs');
...
function MenuBarProvider(props = {}) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _SMHJOY6Pcjs.MenubarProvider, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, props));
}
