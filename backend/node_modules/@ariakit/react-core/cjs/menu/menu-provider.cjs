...
var _6EQNSSQQcjs = require('../__chunks/6EQNSSQQ.cjs');


var _5NYO4PEPcjs = require('../__chunks/5NYO4PEP.cjs');
require('../__chunks/HLFPESUH.cjs');
require('../__chunks/PV4FS33B.cjs');
require('../__chunks/KPH4LMZO.cjs');
require('../__chunks/PTLTNFQI.cjs');
...
function MenuProvider(props = {}) {
  const store = _6EQNSSQQcjs.useMenuStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _5NYO4PEPcjs.MenuContextProvider, { value: store, children: props.children });
}
