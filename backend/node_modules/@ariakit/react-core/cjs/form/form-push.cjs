...
var useFormPush = _6TI3NXX6cjs.createHook.call(void 0, 
  function useFormPush2(_a) {
    ...
    const getItem = _react.useCallback.call(void 0, 
      (item) => {
        const nextItem = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, item), { type: "button", name });
        if (getItemProp) {
...
var FormPush = _6TI3NXX6cjs.forwardRef.call(void 0, function FormPush2(props) {
