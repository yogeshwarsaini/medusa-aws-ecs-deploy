...
var _MVS4G3IXcjs = require('../__chunks/MVS4G3IX.cjs');
...
var _VBD2AUBUcjs = require('../__chunks/VBD2AUBU.cjs');


var _B63GYHMLcjs = require('../__chunks/B63GYHML.cjs');
require('../__chunks/H5ZMZIC6.cjs');
require('../__chunks/PDQXLIRF.cjs');
require('../__chunks/T3QB4FR3.cjs');
require('../__chunks/IRJEBRAW.cjs');
require('../__chunks/RNDUOYIN.cjs');
...
var TagName = "input";
var useFormCheckbox = _6TI3NXX6cjs.createHook.call(void 0, 
  function useFormCheckbox2(_a) {
    ...
    const name = `${nameProp}`;
    const checkboxStore = _VBD2AUBUcjs.useCheckboxStore.call(void 0, {
      value: store.useValue(name),
      setValue: (value2) => store == null ? void 0 : store.setValue(name, value2)
    });
    props = _B63GYHMLcjs.useCheckbox.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store: checkboxStore, value, checked }, props));
    props = _MVS4G3IXcjs.useFormControl.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store,
      name,
...
var FormCheckbox = _6TI3NXX6cjs.memo.call(void 0, 
  _6TI3NXX6cjs.forwardRef.call(void 0, function FormCheckbox2(props) {
