...
var _I6CQ375Jcjs = require('../__chunks/I6CQ375J.cjs');
...
function useSelectItemOffscreen(_a) {
  ...
  store = store || context;
  return _K4YSA433cjs.useCompositeItemOffscreen.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, value }, props));
}
var SelectItem2 = _6TI3NXX6cjs.forwardRef.call(void 0, function SelectItem3(_a) {
  var _b = _a, {
    offscreenBehavior,
    offscreenRoot
  ...
  const _a2 = useSelectItemOffscreen(_7EQBAZ46cjs.__spreadValues.call(void 0, {
    offscreenBehavior,
    offscreenRoot
  ...
  if (active) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _I6CQ375Jcjs.SelectItem, _7EQBAZ46cjs.__spreadValues.call(void 0, {}, allProps));
  }
  const _b2 = allProps, {
    store,
    value,
