...
var _FEGBIZSMcjs = require('../__chunks/FEGBIZSM.cjs');



var _XYLFPE4Scjs = require('../__chunks/XYLFPE4S.cjs');
...
function useSelectRenderer(_a) {
  ...
  const value = _76LCMKUIcjs.useStoreState.call(void 0, store, (state) => valueProp != null ? valueProp : state == null ? void 0 : state.value);
  ...
  return _FEGBIZSMcjs.useCompositeRenderer.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
    store,
    items,
    persistentIndices
  }, props));
}
var SelectRenderer = _6TI3NXX6cjs.forwardRef.call(void 0, function SelectRenderer2(props) {
...
exports.SelectRenderer = SelectRenderer; exports.getSelectRendererItem = _XYLFPE4Scjs.getCollectionRendererItem; exports.getSelectRendererItemId = _XYLFPE4Scjs.getCollectionRendererItemId;
