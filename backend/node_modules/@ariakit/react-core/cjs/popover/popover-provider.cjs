...
var _PTLTNFQIcjs = require('../__chunks/PTLTNFQI.cjs');
require('../__chunks/T272CHVS.cjs');
require('../__chunks/ZRZUZ7E7.cjs');


var _ZVS6SBRRcjs = require('../__chunks/ZVS6SBRR.cjs');
...
function PopoverProvider(props = {}) {
  const store = _PTLTNFQIcjs.usePopoverStore.call(void 0, props);
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _ZVS6SBRRcjs.PopoverContextProvider, { value: store, children: props.children });
}
